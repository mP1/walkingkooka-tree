...
final class DescendantOrSelfNodeSelector<N extends Node<N, NAME, ANAME, AVALUE>, NAME extends Name, ANAME extends Name, AVALUE>
     ...
     * Private constructor
     */
    private DescendantOrSelfNodeSelector(final NodeSelector<N, NAME, ANAME, AVALUE> next) {
        super(next);
    }
    ...
    Visiting traverseStart(final NodeSelectorVisitor<N, NAME, ANAME, AVALUE> visitor) {
        return visitor.startVisitDescendantOrSelf(this);
    }

    @Override
    void traverseEnd(final NodeSelectorVisitor<N, NAME, ANAME, AVALUE> visitor) {
        visitor.endVisitDescendantOrSelf(this);
    }
