...
/**
 * Base class for both {@link AbsoluteNodeSelector} and {@link AxisNodeSelector}.
 */
abstract class AbsoluteOrAxisNodeSelector<N extends Node<N, NAME, ANAME, AVALUE>, NAME extends Name, ANAME extends Name, AVALUE>
