...
public final class NodeSelectorGreaterThanParserToken extends NodeSelectorBinaryParserToken<NodeSelectorGreaterThanParserToken> {
    ...
    @Override
    public Optional<NodeSelectorGreaterThanParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public NodeSelectorGreaterThanParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
    ...
    @Override
    public NodeSelectorGreaterThanParserToken replaceIf(final Predicate<ParserToken> predicate,
                                                        final Function<ParserToken, ParserToken> mapper) {
