...
public final class NegativeNodeSelectorParserToken extends ParentNodeSelectorParserToken<NegativeNodeSelectorParserToken> {
    ...
    static NegativeNodeSelectorParserToken with(final List<ParserToken> value,
                                                final String text) {
        return new NegativeNodeSelectorParserToken(copyAndCheckTokens(value),
            checkTextNullOrWhitespace(text));
    }

    private NegativeNodeSelectorParserToken(final List<ParserToken> value,
                                            final String text) {
        super(value, text);
    ...
    @Override
    public NegativeNodeSelectorParserToken setChildren(final List<ParserToken> children) {
        return ParserToken.parentSetChildren(
            this,
            children,
            NegativeNodeSelectorParserToken::new
        );
    }
