...
public final class NodeSelectorAndParserToken extends NodeSelectorBinaryParserToken<NodeSelectorAndParserToken> {
    ...
    @Override
    public NodeSelectorAndParserToken setChildren(final List<ParserToken> children) {
        return ParserToken.parentSetChildren(
                this,
                children,
                NodeSelectorAndParserToken::with
        );
    }
    ...
    @Override
    public NodeSelectorAndParserToken removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public NodeSelectorAndParserToken removeIf(final Predicate<ParserToken> predicate) {
