...
public final class NodeSelectorNegativeParserToken extends NodeSelectorParentParserToken<NodeSelectorNegativeParserToken> {
    ...
    @Override
    public Optional<NodeSelectorNegativeParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public NodeSelectorNegativeParserToken replaceIf(final Predicate<ParserToken> predicate,
                                                     final Function<ParserToken, ParserToken> mapper) {
