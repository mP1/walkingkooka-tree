...
public final class NodeSelectorFunctionParserToken extends NodeSelectorParentParserToken<NodeSelectorFunctionParserToken> {
    ...
    @Override
    public Optional<NodeSelectorFunctionParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<NodeSelectorFunctionParserToken> removeIf(final Predicate<ParserToken> predicate) {
