...
public final class NodeSelectorDescendantOrSelfParserToken extends NodeSelectorNonSymbolParserToken<String> {
    ...
    @Override
    public Optional<NodeSelectorDescendantOrSelfParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<NodeSelectorDescendantOrSelfParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public NodeSelectorDescendantOrSelfParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
    ...
    @Override
    public NodeSelectorDescendantOrSelfParserToken replaceIf(final Predicate<ParserToken> predicate,
                                                             final Function<ParserToken, ParserToken> mapper) {
