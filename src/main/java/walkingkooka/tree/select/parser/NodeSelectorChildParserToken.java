...
public final class NodeSelectorChildParserToken extends NodeSelectorNonSymbolParserToken<String> {
    ...
    @Override
    public Optional<NodeSelectorChildParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<NodeSelectorChildParserToken> removeIf(final Predicate<ParserToken> predicate) {
