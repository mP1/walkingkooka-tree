 ...
 */
abstract class NonSymbolNodeSelectorParserToken<T> extends LeafNodeSelectorParserToken<T> {

    NonSymbolNodeSelectorParserToken(final T value, final String text) {
        super(value, text);
    }
