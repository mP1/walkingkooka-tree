...
public final class NodeSelectorParenthesisOpenSymbolParserToken extends NodeSelectorNonBinaryOperandSymbolParserToken {
    ...
    @Override
    public Optional<NodeSelectorParenthesisOpenSymbolParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<NodeSelectorParenthesisOpenSymbolParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public NodeSelectorParenthesisOpenSymbolParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
    ...
    @Override
    public NodeSelectorParenthesisOpenSymbolParserToken replaceIf(final Predicate<ParserToken> predicate,
                                                                  final ParserToken token) {
