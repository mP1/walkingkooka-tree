 ...
 */
public final class NodeSelectorGreaterThanEqualsParserToken extends NodeSelectorBinaryParserToken<NodeSelectorGreaterThanEqualsParserToken> {
    ...
    @Override
    public Optional<NodeSelectorGreaterThanEqualsParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<NodeSelectorGreaterThanEqualsParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public NodeSelectorGreaterThanEqualsParserToken replaceIf(final Predicate<ParserToken> predicate,
                                                              final ParserToken token) {
