...
public final class NodeSelectorPlusSymbolParserToken extends NodeSelectorSymbolParserToken {
    ...
    @Override
    public Optional<NodeSelectorPlusSymbolParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<NodeSelectorPlusSymbolParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public NodeSelectorPlusSymbolParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
    ...
    @Override
    public NodeSelectorPlusSymbolParserToken replaceIf(final Predicate<ParserToken> predicate,
                                                       final Function<ParserToken, ParserToken> mapper) {
