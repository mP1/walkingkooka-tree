...
public final class NodeSelectorPrecedingParserToken extends NodeSelectorNonSymbolParserToken<String> {
    ...
    @Override
    public Optional<NodeSelectorPrecedingParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<NodeSelectorPrecedingParserToken> removeIf(final Predicate<ParserToken> predicate) {
