...
public final class NodeSelectorGroupParserToken extends NodeSelectorParentParserToken<NodeSelectorGroupParserToken> {
    ...
    @Override
    public Optional<NodeSelectorGroupParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public NodeSelectorGroupParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
    ...
    @Override
    public NodeSelectorGroupParserToken replaceIf(final Predicate<ParserToken> predicate,
                                                  final ParserToken token) {
