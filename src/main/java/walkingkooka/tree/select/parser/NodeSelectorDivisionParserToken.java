...
public final class NodeSelectorDivisionParserToken extends NodeSelectorBinaryParserToken<NodeSelectorDivisionParserToken> {
    ...
    private NodeSelectorDivisionParserToken(final List<ParserToken> value,
                                            final String text) {
        super(value, text);
    }
    ...
    @Override
    public Optional<NodeSelectorDivisionParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
        return ParserToken.removeFirstIfParent(
                this,
                predicate,
                NodeSelectorDivisionParserToken.class
        );
    }
    ...
    @Override
    public NodeSelectorDivisionParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
    ...
    @Override
    public NodeSelectorDivisionParserToken replaceIf(final Predicate<ParserToken> predicate,
                                                     final Function<ParserToken, ParserToken> mapper) {
