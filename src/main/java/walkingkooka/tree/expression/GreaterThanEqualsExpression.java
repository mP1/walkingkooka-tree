...
public final class GreaterThanEqualsExpression extends CompareExpression {

    public final static ExpressionFunctionName NAME = ExpressionFunctionName.fromClass(GreaterThanEqualsExpression.class);
