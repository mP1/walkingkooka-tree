...
public final class GreaterThanExpression extends BinaryCompareExpression {

    public final static ExpressionFunctionName NAME = ExpressionFunctionName.fromClass(GreaterThanExpression.class);
