...
final class ExpressionNumberReducerBinaryExpressionNumberVisitorMultiply extends ExpressionNumberReducerBinaryExpressionNumberVisitorArithmetic {

    static Number compute(final Number left,
                          final Number right,
                          final ExpressionNumberReducerContext context) {
        final ExpressionNumberReducerBinaryExpressionNumberVisitorMultiply visitor = new ExpressionNumberReducerBinaryExpressionNumberVisitorMultiply(context);
        visitor.accept(left, right);
        return visitor.result;
    }

    ExpressionNumberReducerBinaryExpressionNumberVisitorMultiply(final ExpressionNumberReducerContext context) {
        super(context);
    }
