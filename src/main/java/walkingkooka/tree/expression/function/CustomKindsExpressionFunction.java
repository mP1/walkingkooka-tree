 ...
 */
final class CustomKindsExpressionFunction<T, C extends ExpressionFunctionContext> implements ExpressionFunction<T, C> {
     ...
     */
    static <T, C extends ExpressionFunctionContext> ExpressionFunction<T, C> unwrap(final CustomKindsExpressionFunction<T, C> function,
                                                                                    final Set<ExpressionFunctionKind> kinds) {
