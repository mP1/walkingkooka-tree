 ...
 */
final class BooleanExpressionFunction extends ExpressionFunction2<Boolean> {
    /**
     * Singleton
     */
    static final BooleanExpressionFunction INSTANCE = new BooleanExpressionFunction();
