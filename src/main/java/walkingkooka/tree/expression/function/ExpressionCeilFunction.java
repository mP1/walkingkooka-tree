 ...
 */
final class ExpressionCeilFunction extends ExpressionNumberFunction2 {

    /**
     * Singleton
     */
    static final ExpressionCeilFunction INSTANCE = new ExpressionCeilFunction();

    /**
     * Private ctor
     */
    private ExpressionCeilFunction() {
        super();
    }
