...
public final class ExpressionNumberReducer {
     ...
     */
    public boolean equals(final Number value) {
        return ExpressionNumberReducerBinaryExpressionNumberVisitor.equals(this.value, value, this.context);
    }
    ...
    /**
     * Compares if the current value is greater than equal the given value.
     */
    public boolean greaterThanEquals(final Number value) {
        return ExpressionNumberReducerBinaryExpressionNumberVisitor.greaterThanEquals(this.value, value, this.context);
    }
    ...
    public boolean lessThan(final Number value) {
        return ExpressionNumberReducerBinaryExpressionNumberVisitor.lessThan(this.value, value, this.context);
    }
