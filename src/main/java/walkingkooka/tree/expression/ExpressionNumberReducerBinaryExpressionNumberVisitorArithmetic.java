 ...
 * to do actual work.
 */
abstract class ExpressionNumberReducerBinaryExpressionNumberVisitorArithmetic extends ExpressionNumberReducerBinaryExpressionNumberVisitor {

    ExpressionNumberReducerBinaryExpressionNumberVisitorArithmetic(final ExpressionNumberReducerContext context) {
        super(context);
    }
