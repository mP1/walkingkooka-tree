...
public final class NodeSelectorSlashSeparatorSymbolParserTokenTest extends NodeSelectorSymbolParserTokenTestCase<NodeSelectorSlashSeparatorSymbolParserToken, String> {
    ...
    public void testAccept() {
        ...
        new FakeNodeSelectorParserTokenVisitor() {
            ...
            @Override
            protected void visit(final NodeSelectorSlashSeparatorSymbolParserToken t) {
                assertSame(token, t);
                b.append("5");
            }
        }.accept(token);
    ...
    @Override
    public Class<NodeSelectorSlashSeparatorSymbolParserToken> type() {
        return NodeSelectorSlashSeparatorSymbolParserToken.class;
    }
}
