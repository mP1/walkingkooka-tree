...
public final class NodeSelectorGreaterThanSymbolParserTokenTest extends NodeSelectorSymbolParserTokenTestCase<NodeSelectorGreaterThanSymbolParserToken, String> {

    @Test
    public void testAccept() {
        final StringBuilder b = new StringBuilder();
        final NodeSelectorGreaterThanSymbolParserToken token = this.createToken();
        ...
        new FakeNodeSelectorParserTokenVisitor() {
            ...
            @Override
            protected void visit(final NodeSelectorGreaterThanSymbolParserToken t) {
                assertSame(token, t);
                b.append("5");
            }
        }.accept(token);
