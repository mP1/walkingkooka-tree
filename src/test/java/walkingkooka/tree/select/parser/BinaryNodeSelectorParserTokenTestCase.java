...
public abstract class BinaryNodeSelectorParserTokenTestCase<T extends BinaryNodeSelectorParserToken<T>> extends ParentNodeSelectorParserTokenTestCase<T> {

    BinaryNodeSelectorParserTokenTestCase() {
        super();
    }
