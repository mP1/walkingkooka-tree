...
public final class NodeSelectorDescendantParserTokenTest extends NodeSelectorNonSymbolParserTokenTestCase<NodeSelectorDescendantParserToken, String> {

    @Test
    public void testAccept() {
        final StringBuilder b = new StringBuilder();
        final NodeSelectorDescendantParserToken token = this.createToken();
        ...
        new FakeNodeSelectorParserTokenVisitor() {
            ...
            @Override
            protected void visit(final NodeSelectorDescendantParserToken t) {
                assertSame(token, t);
                b.append("5");
            }
        }.accept(token);
    ...
    @Override
    public Class<NodeSelectorDescendantParserToken> type() {
        return NodeSelectorDescendantParserToken.class;
    }
}
