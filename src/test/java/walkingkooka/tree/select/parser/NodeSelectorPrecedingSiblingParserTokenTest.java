...
public final class NodeSelectorPrecedingSiblingParserTokenTest extends NodeSelectorNonSymbolParserTokenTestCase<NodeSelectorPrecedingSiblingParserToken, String> {

    @Test
    public void testAccept() {
        final StringBuilder b = new StringBuilder();
        final NodeSelectorPrecedingSiblingParserToken token = this.createToken();
        ...
        new FakeNodeSelectorParserTokenVisitor() {
            ...
            @Override
            protected void visit(final NodeSelectorPrecedingSiblingParserToken t) {
                assertSame(token, t);
                b.append("5");
            }
        }.accept(token);
    ...
    @Override
    public Class<NodeSelectorPrecedingSiblingParserToken> type() {
        return NodeSelectorPrecedingSiblingParserToken.class;
    }
}
