...
public final class NodeSelectorFollowingParserTokenTest extends NodeSelectorNonSymbolParserTokenTestCase<NodeSelectorFollowingParserToken, String> {

    @Test
    public void testAccept() {
        final StringBuilder b = new StringBuilder();
        final NodeSelectorFollowingParserToken token = this.createToken();
        ...
        new FakeNodeSelectorParserTokenVisitor() {
            ...
            @Override
            protected void visit(final NodeSelectorFollowingParserToken t) {
                assertSame(token, t);
                b.append("5");
            }
        }.accept(token);
    ...
    @Override
    public Class<NodeSelectorFollowingParserToken> type() {
        return NodeSelectorFollowingParserToken.class;
    }
}
