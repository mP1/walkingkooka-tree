...
public final class NodeSelectorAncestorOrSelfParserTokenTest extends NodeSelectorNonSymbolParserTokenTestCase<NodeSelectorAncestorOrSelfParserToken, String> {

    @Test
    public void testAccept() {
        final StringBuilder b = new StringBuilder();
        final NodeSelectorAncestorOrSelfParserToken token = this.createToken();
        ...
        new FakeNodeSelectorParserTokenVisitor() {
            ...
            @Override
            protected void visit(final NodeSelectorAncestorOrSelfParserToken t) {
                assertSame(token, t);
                b.append("5");
            }
        }.accept(token);
