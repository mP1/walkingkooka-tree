...
public abstract class ExpressionNumberReducerBinaryExpressionNumberVisitorTestCase<V extends ExpressionNumberReducerBinaryExpressionNumberVisitor>
        extends ExpressionNumberReducerTestCase<V>
        implements BinaryExpressionNumberVisitorTesting<V>, ToStringTesting<V> {

    ExpressionNumberReducerBinaryExpressionNumberVisitorTestCase() {
        super();
    }
