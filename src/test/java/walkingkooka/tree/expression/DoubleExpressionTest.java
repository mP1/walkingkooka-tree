...
public final class DoubleExpressionTest extends LeafExpressionTestCase<DoubleExpression, Double> {

    @Test
    public void testAccept() {
        final StringBuilder b = new StringBuilder();
        final DoubleExpression node = this.createExpression();
        ...
        new FakeExpressionVisitor() {
            ...
            @Override
            protected void visit(final DoubleExpression n) {
                assertSame(node, n);
                b.append("3");
            }
        }.accept(node);
    ...
    public void testToNumberDouble() {
        this.evaluateAndCheckNumberDouble(this.createExpression(123), 123);
    }
    ...
    public void testToString() {
        this.toStringAndCheck(this.createExpression(1.0), "1.0");
    }

    @Test
    public void testToString2() {
        this.toStringAndCheck(this.createExpression(234.5), "234.5");
    }

    private DoubleExpression createExpression(final double value) {
        return this.createExpression(Double.valueOf(value));
    }

    @Override
    DoubleExpression createExpression(final Double value) {
    ...
    @Override
    Class<DoubleExpression> expressionType() {
