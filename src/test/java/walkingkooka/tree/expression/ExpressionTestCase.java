    ...
    ExpressionEvaluationContext context() {
        ...
        final Converter<ExpressionNumberConverterContext> converters = Converters.collection(
                Lists.of(
                        ...
                        ExpressionNumberConverters.numberOrExpressionNumberTo(Converters.numberToLocalDate(Converters.JAVA_EPOCH_OFFSET)),
                        ExpressionNumberConverters.numberOrExpressionNumberTo(Converters.numberToLocalDateTime(Converters.JAVA_EPOCH_OFFSET)),
                        ExpressionNumberConverters.numberOrExpressionNumberTo(Converters.numberToLocalTime()),
                        ExpressionNumberConverters.numberOrExpressionNumberTo(Converters.numberToString((c) -> new DecimalFormat("#.###"))),
                        // Number ->),
                        ExpressionNumberConverters.numberOrExpressionNumberTo(Converters.numberToNumber()),
                        ExpressionNumberConverters.numberOrExpressionNumberTo(Converters.numberToBoolean()),
                        ExpressionNumberConverters.numberOrExpressionNumberTo(Converters.numberToLocalDate(Converters.JAVA_EPOCH_OFFSET)),
