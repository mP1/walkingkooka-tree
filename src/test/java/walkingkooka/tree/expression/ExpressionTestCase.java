    ...
    ExpressionEvaluationContext context() {
        ...
        final Converter<ExpressionNumberConverterContext> converters = Converters.collection(
                Lists.of(
                        ...
                        ExpressionNumber.numberOrExpressionNumberTo(Converters.numberToLocalDate(Converters.JAVA_EPOCH_OFFSET)),
                        ExpressionNumber.numberOrExpressionNumberTo(Converters.numberToLocalDateTime(Converters.JAVA_EPOCH_OFFSET)),
                        ExpressionNumber.numberOrExpressionNumberTo(Converters.numberToLocalTime()),
                        ExpressionNumber.numberOrExpressionNumberTo(Converters.numberToString((c) -> new DecimalFormat("#.###"))),
                        // Number ->),
                        ExpressionNumber.numberOrExpressionNumberTo(Converters.numberToNumber()),
                        ExpressionNumber.numberOrExpressionNumberTo(Converters.numberToBoolean()),
                        ExpressionNumber.numberOrExpressionNumberTo(Converters.numberToLocalDate(Converters.JAVA_EPOCH_OFFSET)),
