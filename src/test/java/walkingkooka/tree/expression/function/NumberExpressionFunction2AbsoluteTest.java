...
public final class NumberExpressionFunction2AbsoluteTest extends NumberExpressionFunction2TestCase<NumberExpressionFunction2Absolute> {
    ...
    @Override
    public NumberExpressionFunction2Absolute createBiFunction() {
        return NumberExpressionFunction2Absolute.INSTANCE;
    }

    @Override
    public Class<NumberExpressionFunction2Absolute> type() {
        return NumberExpressionFunction2Absolute.class;
    }
