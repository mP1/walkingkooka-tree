...
public final class ExpressionFunctionTesting2Test implements ClassTesting<ExpressionFunctionTesting2<?, ?, ?>> {

    private final static ExpressionEvaluationContext CONTEXT = ExpressionEvaluationContexts.fake();

    private final ExpressionFunctionTesting2<ExpressionFunction<Object, ExpressionEvaluationContext>, Object, ExpressionEvaluationContext> TESTING = new ExpressionFunctionTesting2<>() {

        @Override
        public ExpressionFunction<Object, ExpressionEvaluationContext> createBiFunction() {
            return ExpressionFunctionTesting2Test.this.stringConcatParameters();
        }
        ...
        public ExpressionEvaluationContext createContext() {
            return ExpressionFunctionTesting2Test.this.createContext();
        }
    ...
    public void testApplyAndCheck() {
        ...
        new ExpressionFunctionTesting2<>() {
    ...
    abstract static class TestExpressionFunctionTesting implements ExpressionFunctionTesting2<FakeExpressionFunction<Void, FakeExpressionEvaluationContext>, Void, FakeExpressionEvaluationContext> {
    ...
    @Override
    public Class<ExpressionFunctionTesting2<?, ?, ?>> type() {
        return Cast.to(ExpressionFunctionTesting2.class);
    }
}
