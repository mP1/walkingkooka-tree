...
public final class NumberExpressionFunction2CeilTest extends NumberExpressionFunction2TestCase<NumberExpressionFunction2Ceil> {
    ...
    @Override
    public NumberExpressionFunction2Ceil createBiFunction() {
        return NumberExpressionFunction2Ceil.INSTANCE;
    }

    @Override
    public Class<NumberExpressionFunction2Ceil> type() {
        return NumberExpressionFunction2Ceil.class;
    }
