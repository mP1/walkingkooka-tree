...
public abstract class ExpressionNumberReducerTestCase<T> implements ClassTesting<T> {
    ...
    ExpressionNumberReducerTestCase() {
        super();
    }

    static Number bigDecimalFix(final Number number) {
